                ...
                if(srcMatch && srcMatch[2]){
                   ...
                   hd.appendChild(s);
                    ...
                    if(window.execScript) {
                       window.eval(match[2]);
                    	//14/01/2008 -> Esta función me daba error con eval funciona!!!
...
Ext.util.JSON = new (function(){
    ...
    this.decode = function(json){
    	//09-02-2008: Parche para hacer que funcione los formulario con uploadForm
    	json=json.split('<pre>').join('');
    	json=json.split('</pre>').join('');
