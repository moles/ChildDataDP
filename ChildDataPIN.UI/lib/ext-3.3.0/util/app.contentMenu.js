...
Ext.extend(Ext.ux.ComponentHolder, Ext.Panel,
{
                ...
                Ext.Ajax.request(
                {
                    ...
                    success: function (xhr) {
                        try {
                            ...
                            contentMenu.setComponent(newComponent, node);
                        }
                        catch (ex) {
                            alert(Ext.util.JSON.encode(ex));
                            contentMenu.fireEvent('componentloadfailure', this, node.getOwnerTree());
                        }
                        contentMenu.unMask();
                    },
                    failure: function (ex) {
    ...
    mask: function () {
        this.getEl().mask('Cargando...');
    },
    unMask: function () {
        this.getEl().unmask();
    }
});
Ext.ux.ContentMenu = function (config) {
    Ext.apply(this, config);
    Ext.ux.ContentMenu.superclass.constructor.call(this,
    {
        id: 'content-menu'
    });
};
Ext.extend(Ext.ux.ContentMenu, Ext.Viewport,
{
    titleTemplate: '',
    topPanel: null,
    ...
    initComponent: function () {
        ...
        Ext.apply(this,
        {
            ...
            this.topPanel,
            {
                ...
                region: 'south',
                height: 32,
                style: 'background: #abc url(../lib/ext-3.3.0/resources/images/default/qtip/bg.gif) repeat-x; border: solid 1px #abc;'
        ...
        Ext.ux.ContentMenu.superclass.initComponent.apply(this, arguments);
    },
    initTopPanel: function () {
        var titleTemplateMarkup = ['<div style="padding-left:50px;padding-right:50px;"><div style="border: solid 2px red; height: 160px; background: #abc url(../lib/ext-3.3.0/resources/images/planheader.jpg) no-repeat;"/>'];
        ...
        this.topPanel = new Ext.Panel(
        {
            ...
            region: 'north',
            bbar: new Ext.Toolbar(//aqui puedo poner un menu horizontal
            {
        ...
        items: [
            {
                ...
                region: 'center',
                baseCls: 'x-plain',
                style: 'background-color:#DFE8F; border: solid 1px blue;',
                hideBorders: true,
                html: ''
            }]
    });
...
createMenuPanel: function (config) {
    ...
    menuPanel.on('menuitemselect', function (node) {
        contentMenu.componentHolder.loadComponent(node);
    });
...
updateMenu: function () {
    if (this.menuPanel) {
        ...
        this.menuPanel.root.eachChild(function (node) {
            ...
            //node.eachChild(contentMenu.validateMenuLink, contentMenu);
            node.eachChild(function (node) {
                contentMenu.validateMenuLink(node, contentMenu);
            })
        });
    }
},
