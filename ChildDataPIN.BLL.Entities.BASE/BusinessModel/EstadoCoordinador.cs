...
namespace ChildDataPIN.BLL.Entities.BASE
{
    ...
    public partial class EstadoCoordinador: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.Guid IdEstadoCoordinador
        {
            ...
            set
            {
                if (_idEstadoCoordinador != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdEstadoCoordinador' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupCoordinador(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.EstadoCoordinador, this))
                    {
                        item.EstadoCoordinador = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
