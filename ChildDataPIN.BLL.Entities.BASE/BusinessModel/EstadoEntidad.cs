...
namespace ChildDataPIN.BLL.Entities.BASE
{
    ...
    public partial class EstadoEntidad: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Entidad> Entidad
        {
            get
            {
                if (_entidad == null)
                {
                    _entidad = new TrackableCollection<Entidad>();
                    _entidad.CollectionChanged += FixupEntidad;
                }
                return _entidad;
            }
            set
        ...
        private TrackableCollection<Entidad> _entidad;
        ...
        private void FixupEntidad(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Entidad item in e.NewItems)
                {
                    item.EstadoEntidad = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Entidad", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Entidad item in e.OldItems)
                {
                    if (ReferenceEquals(item.EstadoEntidad, this))
                    {
                        item.EstadoEntidad = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Entidad", item);
                    }
                }
            }
        }
